...
#define LangS(%1) fmt("^4[^1~^3|^4HerBoy^3|^1~^4] ^3»^1 %l", %1)

const WeaponIdType:WEAPON_ID = WEAPON_SMOKEGRENADE;
const WeaponIdType:WEAPON_NEW_ID = WEAPON_FIVESEVEN;
...
public plugin_init() {
	...
	//register_event("HLTV", "OnNewRoundGiveNades", "a", "1=0", "2=0");
